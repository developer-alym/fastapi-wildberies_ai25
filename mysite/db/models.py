...
class UserProfile(Base):
    ...
    user_review: Mapped[List['Review']] = relationship('Review',
                                                       back_populates='user', cascade='all, delete-orphan')
    cart_user: Mapped['Cart'] = relationship('Cart',
                                             back_populates='user', cascade='all, delete-orphan')
...
class SubCategory(Base):
    ...
    sub_product: Mapped[List['Product']] = relationship('Product',
...
class Product(Base):
    ...
    images_product: Mapped[List['ImageProduct']] = relationship('ImageProduct',
                                                                back_populates='product', cascade='all, delete-orphan')
    reviews_product: Mapped[List['Review']] = relationship('Review',
                                                           back_populates='product', cascade='all, delete-orphan')
    cart_product: Mapped[List['CartItem']] = relationship('CartItem',
                                                          back_populates='product', cascade='all, delete-orphan')
    favorite_product: Mapped['FavoriteItem'] = relationship('FavoriteItem',
                                                            back_populates='product', cascade='all, delete-orphan')
...
class Favorite(Base):
    ...
    favorite_items: Mapped[List['FavoriteItem']] = relationship('FavoriteItem',
                                                                back_populates='favorite', cascade='all, delete-orphan')
